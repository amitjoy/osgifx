 ...
 * mechanics of how each task will be executed, including thread usage, scheduling, and other details. An
 * {@code Executor}
...
public interface Executor {
    ...
    /**
     * Executes the specified command at some point in the future. The command may execute in a new thread, a pooled
     * thread,
     ...
     * executions
     * are suppressed. Otherwise, the task will only terminate via cancellation or termination of the executor. If any
     * execution
     * of this task takes longer than its period, subsequent executions may start late but will not execute
     * concurrently.
     *
