...
public final class DataRetrievedEventTopics {
    ...
    public static final String DATA_RETRIEVED_CONFIGURATIONS_TOPIC  = DATA_RETRIEVED_EVENT_TOPIC_PREFIX
            + "configurations";
    public static final String DATA_RETRIEVED_HEALTHCHECKS_TOPIC    = DATA_RETRIEVED_EVENT_TOPIC_PREFIX
            + "healthchecks";
    ...
    public static final String DATA_RETRIEVED_CAPABILITIES_TOPIC    = DATA_RETRIEVED_EVENT_TOPIC_PREFIX
            + "capabilities";
    public static final String DATA_RETRIEVED_CONDITIONS_TOPIC      = DATA_RETRIEVED_EVENT_TOPIC_PREFIX + "conditions";
