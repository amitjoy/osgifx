...
@McpToolDef(name = "osgi_get_components", description = "Returns the detailed information of all the registered DS service components")
public class GetComponentsTool implements McpTool {
    ...
    public Object execute(final Map<String, Object> args) throws Exception {
        logger.atInfo().log("Executing GetComponentsTool");
        ...
        logger.atInfo().log("Retrieved components: %s", components.size());
        return components;
    }
}
