...
@McpToolDef(name = "osgi_get_bundles", description = "Returns the detailed information of all the installed bundles")
public class GetBundlesTool implements McpTool {
    ...
    public Object execute(final Map<String, Object> args) throws Exception {
        logger.atInfo().log("Executing GetBundlesTool");
        ...
        logger.atInfo().log("Retrieved bundles: %s", bundles.size());
        return bundles;
    }
}
