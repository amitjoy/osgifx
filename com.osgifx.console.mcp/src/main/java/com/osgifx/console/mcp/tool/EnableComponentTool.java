...
@McpToolDef(name = "enable_component", description = "Enables a Declarative Services (DS) component by name.")
public class EnableComponentTool implements McpTool {
    ...
    public Map<String, Object> inputSchema() {
        return McpToolSchema.builder().arg("name", "string", "The name of the component to enable").build();
    }

    @Override
    public Object execute(final Map<String, Object> args) throws Exception {
        logger.atInfo().log("Executing EnableComponentTool");
        ...
        if (result.result == XResultDTO.ERROR) {
            return "Error enabling component '" + name + "': " + result.response;
        }
        return "Component '" + name + "' enabled successfully";
    }
}
