...
public final class ThreadDumpOptionsDialog extends Dialog<ThreadDumpOptionsDialog.ThreadDumpOption> {
    ...
    public enum ThreadDumpOption {
        USE_HANDLER,
        USE_RPC,
        STORE_LOCALLY
    }

    public static final class ThreadDumpStatistics {
        ...
        public ThreadDumpStatistics(final long estimatedUncompressedSize,
    ...
    public void init(final ThreadDumpStatistics stats) {
        final var dialogPane = getDialogPane();
        initStyle(StageStyle.UNDECORATED);
        dialogPane.getStylesheets().add(getClass().getResource(STANDARD_CSS).toExternalForm());

        dialogPane.setHeaderText("Thread Dump Capture Options");
        ...
        final var dialogContent = Fx.loadFXML(loader, context, "/fxml/threaddump-options-dialog.fxml");
        dialogPane.setContent(dialogContent);

        final var controller = (ThreadDumpOptionsDialogController) loader.getController();
