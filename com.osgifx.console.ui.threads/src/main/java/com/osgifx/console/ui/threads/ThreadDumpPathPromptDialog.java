...
public final class ThreadDumpPathPromptDialog extends Dialog<String> {
    ...
    public void init(final String defaultPath, final String title, final String description) {
        ...
        pathField.setPromptText("Enter full file path on agent (e.g., {env:TEMP}/threaddump-2024.tdump.gz)");
