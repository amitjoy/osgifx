...
public final class HeapdumpPathPromptDialog extends Dialog<String> {
    ...
    public void init(final String defaultPath, final String title, final String description) {
        ...
        dialogPane.setGraphic(new ImageView(this.getClass().getResource("/graphic/images/heapdump.png").toString()));
