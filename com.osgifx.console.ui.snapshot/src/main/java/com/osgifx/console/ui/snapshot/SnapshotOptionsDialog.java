...
public final class SnapshotOptionsDialog extends Dialog<SnapshotOptionsDialog.SnapshotOption> {
    ...
    public static final class SnapshotStatistics {
        ...
        public SnapshotStatistics(int bundleCount,
                                  int serviceCount,
                                  long estimatedUncompressedSize,
                                  long estimatedCompressedSize,
                                  boolean isMqttTransport,
                                  boolean rpcAvailable,
                                  LargePayloadHandler handler) {
    ...
    public void init(final SnapshotStatistics stats) {
        final var dialogPane = getDialogPane();
        initStyle(StageStyle.UNDECORATED);
        dialogPane.getStylesheets().add(getClass().getResource(STANDARD_CSS).toExternalForm());

        dialogPane.setHeaderText("Snapshot Capture Options");
        ...
        final var dialogContent = Fx.loadFXML(loader, context, "/fxml/snapshot-options-dialog.fxml");
        dialogPane.setContent(dialogContent);

        final var controller = (SnapshotOptionsDialogController) loader.getController();
