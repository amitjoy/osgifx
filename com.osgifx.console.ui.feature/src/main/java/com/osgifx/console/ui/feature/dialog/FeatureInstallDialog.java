...
public final class FeatureInstallDialog extends Dialog<SelectedFeaturesDTO> {
	...
	public void init() {
		...
		final var dialogContent = Fx.loadFXML(loader, context, "/fxml/install-feature-dialog.fxml");
		dialogPane.setContent(dialogContent);

		final var controller = (InstallFeatureDialogController) loader.getController();
