    ...
    private void createControls(final BorderPane parent, final FXMLLoader loader) {
        ...
        final Task<Void> task = new Task<>() {
            ...
            protected Void call() throws Exception {
                final var fxml = context.getBundle().getResource("/fxml/tab-content.fxml");
                loader.setLocation(Objects.requireNonNull(fxml, "FXML not found: /fxml/tab-content.fxml"));
            ...
            protected void failed() {
                final var error = getException();
                logger.atError().withException(error).log("Failed to render MCP UI");
                parent.getChildren().clear();
