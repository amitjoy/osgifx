...
-   **🛡️ Standalone Independence:** The Eclipse Plugin runs entirely separate from the desktop application—you **do not** need to install the standalone app to use it.

## Update Sites

If you prefer to install it manually without the marketplace, you can use `Help > Install New Software...` in Eclipse and use the following update sites:
