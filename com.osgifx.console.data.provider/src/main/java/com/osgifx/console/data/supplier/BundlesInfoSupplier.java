...
public final class BundlesInfoSupplier implements RuntimeInfoSupplier, EventHandler, EventListener {
	...
	private final ObservableList<XBundleDTO> bundles = synchronizedObservableList(observableArrayList());
