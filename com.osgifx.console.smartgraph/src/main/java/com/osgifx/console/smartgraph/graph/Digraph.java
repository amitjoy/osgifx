 ...
 * <br>
 * An directed-edge leaves the <i>outbound vertex</i> towards the <i>inbound
 * vertex</i> and this changes the reasoning behind some methods of the
 * {@link Graph} interface, which are overridden in this interface so as to
 * provide different documentation of expected behavior.
 *
