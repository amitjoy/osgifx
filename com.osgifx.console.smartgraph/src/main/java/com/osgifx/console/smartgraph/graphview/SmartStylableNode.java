...
public interface SmartStylableNode {
	 ...
	 * any css classes set by
	 * {@link SmartStylableNode#addStyleClass(java.lang.String) }. But will be
	 * discarded if you use
	 * {@link SmartStylableNode#setStyleClass(java.lang.String) }
	 *
	 ...
	 *
	 * The CSS Class must be defined in <code>smartpgraph.css</code> file or in the
	 * custom provided stylesheet.
	 *
	 * The expected behavior is to remove all current styling before applying the
	 * class css.
	 *
	 ...
	 *
	 * Given styles can be added sequentially, the removal of a css class will be a
	 * removal that keeps the previous ordering of kept styles.
	 *
	 * @param cssClass name of the CSS class.
	 *
	 * @return true if successful; false if <code>cssClass</code> wasn't previously
	 *         set.
	 */
