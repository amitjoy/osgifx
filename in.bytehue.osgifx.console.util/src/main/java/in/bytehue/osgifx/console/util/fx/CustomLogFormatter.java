...
public final class CustomLogFormatter extends Formatter {
    ...
    public CustomLogFormatter() {
        ...
        final String dateFormatKey = classname + ".date.format";

        final String strDateFormat = logManager.getProperty(dateFormatKey);
        ...
        final String propName = classname + ".format";
    ...
    public StringBuffer getEclipseFormat(final StringBuffer sb) {
        ...
        final StackTraceElement element = findCallingElement(stackTrace);
    ...
    public static StackTraceElement findCallingElement(final StackTraceElement[] stackTrace) {
        ...
        final int lastIdx = firstIndexNot(stackTrace, Logger.class.getName(), 7);
